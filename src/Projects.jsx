...
/* ═══════════════════════════════════════════════════════════
   CSS INJECTION — Pattern identique Skills.jsx + About.jsx
...
/* ── BottomStatCard — état hover propre, shimmer via classe CSS ── */
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(135deg,${s.gr})`,
          opacity: hovered ? 0.14 : 0.04,
        }}
        aria-hidden="true"
      />
      ...
      {/* Shimmer bar — width via state, transition via classe CSS */}
      <div
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ opacity: hovered && !reduced ? 0.35 : 0 }}
        aria-hidden="true"
      />
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          /*
           * ── Fond identique Skills.jsx + About.jsx ──
           * Transparent → GlobalBackground (canvas fixed) visible
           */
      ...
      >
        ...
        {/* ── Ambient orbs — pattern identique Skills.jsx + About.jsx ── */}
        <div
        ...
        <div className="container relative mx-auto px-4 md:px-10 z-10 max-w-[1400px]">
          ...
          >
            {/* Badge — classes CSS (pattern identique About/Skills) */}
            ...
            {/* Title — classe pj-gt (pattern identique sk-gt / ab-gt) */}
            ...
            {/* Divider — identique About.jsx + Skills.jsx */}
            <motion.div
          ...
          {/* ── Footer divider — identique Skills.jsx + About.jsx ── */}
          <motion.div
            initial={{ opacity: 0, scaleX: 0 }}
            whileInView={{ opacity: 1, scaleX: 1 }}
            viewport={{ once: true }}
